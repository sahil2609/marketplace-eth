...
contract CourseMarketplace {
  ...
  address payable private owner; //administrator of the contract
  ...
  error OnlyOwner();
  //above written will give the commented error
  ...
  function resumeContract() external onlyOwner { isStopped=false;}
...
//     function setContractOwner(address newOwner) private{
//         owner = payable(newOwner); //make the owner payable
//     }
...
// }
// // abi - abstract binary index
// //keccak here is run on course id + address
// //first we should have constructor, external, view, public, private
// //storage is used in place of memory whenever we want ot chnage data
// //that also gets updataed in the memory