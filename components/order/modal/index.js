          ...
          <div className="sm:flex sm:items-start">
            <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="text-xs text-gray-700 flex mt-5">
                ...
                <span>I accept all &apos;terms of service&apos; and I agree that my order can be rejected in the case data provided above are not correct</span>
              </div>
              { formState.message &&
...
//a solution is written so that we can again 
//open the modal after closing the same course
//isNaN - not a number
//trim is used to get rid of the starting and ending empty spaces
